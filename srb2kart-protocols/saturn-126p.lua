...
function Protocol:initialize(socket, server)
    ...
    self.MAXPLAYERS = 127 -- Server is called 126p because one of slots is taken by dedicated server slot (yes listen servers exist but shhhhh)
    ...
    self.serverinfo = RawPacket:new({
        ...
        { "c16", "mapmd5", }, -- Warning - its just bytes! Not an actual "human readable" value
        { "I1", "actnum", },
        { "I1", "iszone", },
